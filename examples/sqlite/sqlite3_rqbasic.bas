...
DECLARE FUNCTION sqlite3_win32_set_directory LIB "sqlite3" ALIAS "sqlite3_win32_set_directory" (_type AS UINT64, zValue AS POINTER) AS INTEGER
DECLARE FUNCTION sqlite3_win32_set_directory8 LIB "sqlite3" ALIAS "sqlite3_win32_set_directory8" (_type AS UINT64, zValue AS POINTER) AS INTEGER
DECLARE FUNCTION sqlite3_win32_set_directory16 LIB "sqlite3" ALIAS "sqlite3_win32_set_directory16" (_type AS UINT64, zValue AS POINTER) AS INTEGER
